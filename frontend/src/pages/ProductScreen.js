    ...
    <div>
      ...
      {loading ? (
        ...
        <div>
          <Row>
            <Col md={6}>
              <Image src={`${configs.UrlPrefix}${product.image}`} alt={product.name} fluid />
            </Col>
            ...
            <Col md={3}>
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>{t('Price')}: {product.price} {t('THB')}</ListGroup.Item>
            ...
            <Col>
              <Card>
                <ListGroup variant="flush">
                  <ListGroup.Item>
                    <Row>
                      <Col>{t('Unit Price')}:</Col>
                      <Col>
                        <strong>{product.price}{t('THB')}</strong>
                      </Col>
                    </Row>
                  </ListGroup.Item>
                  ...
                  <ListGroup.Item>
                    <Row>
                      <Col>{t('Status')}:</Col>
                      <Col>
                        {product.countInStock > 0 ? t("Avliable") : t("Unavalable")}
                      </Col>
                    </Row>
                  </ListGroup.Item>
          ...
          <Row>
            <Col md={6}>
              <h4 className="mt-3">{t('Reviews')}</h4>
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  ...
                  {successProductReview && (
                    <Message variant="success">{t('Review Submitted')}</Message>
                  )}
                  {errorProdcutReview && (
                  ...
                  {userInfo ? (
                    ...
                    <Message variant="info">
                      {t('Please')} <Link to="/login">{t('Login')}</Link> {t('to write a review')}.
                    </Message>
                  )}
                </ListGroup.Item>
              </ListGroup>
