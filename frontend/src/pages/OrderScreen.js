        ...
        <Col md={8}>
          <ListGroup variant="flush">
            ...
            <h2>{t('Details')}</h2>
              ...
              <p>
                <strong>{t('Recipient Name')} : </strong>{order.bookingDetails.namebook}
                </p>
                <p>
                <strong>{t('Address')} : </strong>{order.bookingDetails.bookgo}
              </p>
                <p>
                <strong>{t('Phone Number')} : </strong>{order.bookingDetails.tel}
                </p>
                <p>
                <strong>{t('Postal Code')} : </strong>{order.bookingDetails.bdate}
                </p>
                  ...
                  <CardActionArea>
                    ...
                    <CardContent>
                      <Typography variant="body2" color="text.secondary">
                        <div>
                        {t('Account Name')}: นาย ปณัฐฑรณ์ ชนาชน
                        </div>
                        <div>
                        {t('PromptPay')}: 0928257244
                        </div>
                      </Typography>
                    </CardContent>
                  </CardActionArea>
