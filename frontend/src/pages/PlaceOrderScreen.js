        ...
        <Col md={8}>
          ...
          <Card className="cardplaceorder" sx={{margin: '2%'}}>
            ...
            <ListGroup.Item>
              ...
              <br></br>
              <strong>{t('Address')} : {cart.bookingDetails.bookgo}</strong>
              <br></br>
              <strong>{t('Phone Number')} : {cart.bookingDetails.tel}</strong>
              <br></br>
              <strong>{t('Postal Code')} : {cart.bookingDetails.bdate}</strong>
