...
export const listProducts =
  ...
  async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`${configs.UrlPrefix}/api/products${keyword}`);
...
export const deleteProduct = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete(`${configs.UrlPrefix}/api/products/delete/${id}/`, config);
...
export const createProduct = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`${configs.UrlPrefix}/api/products/create/`, {}, config);
...
export const updateProduct = (product) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `${configs.UrlPrefix}/api/products/update/${product._id}/`,
      product,
      config
    );
  ...
  (productId, review) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.post(
        `${configs.UrlPrefix}/api/products/${productId}/reviews/`,
        review,
        config
      );
...
export const listTopProducts = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${configs.UrlPrefix}/api/products/top/`);
