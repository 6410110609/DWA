...
export const login = (email, password) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${configs.UrlPrefix}/api/users/login/`,
...
export const register = (name, email, password) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${configs.UrlPrefix}/api/users/register/`,
...
export const getUserDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${configs.UrlPrefix}/api/users/${id}/`, config);
...
export const updateUserProfile = (user) => async (dispatch, getState) => {
  try {
    ...
    // USING ${id} BECAUSE WHILE ACCESSING NORMAL USER WE'LL PASS STRING 'profile' BUT WHILE ACCESSING ADMIN PANEL WE'LL PASS THE 'id' SO LINK HAS TO BE DYNAMIC
    const { data } = await axios.put(`${configs.UrlPrefix}/api/users/profile/update`, user, config);
...
export const listUsers = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${configs.UrlPrefix}/api/users/`, config);
...
export const deleteUser = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete(`${configs.UrlPrefix}/api/users/delete/${id}`, config);
...
export const updateUser = (user) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `${configs.UrlPrefix}/api/users/update/${user._id}/`,
      user,
      config
    );
