...
export const createOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`${configs.UrlPrefix}/api/orders/add/`, order, config);
...
export const getOrderDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${configs.UrlPrefix}/api/orders/${id}/`, config);
...
export const payOrder = (id, paymentResult) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `${configs.UrlPrefix}/api/orders/${id}/pay/`,
      paymentResult,
      config
    );
...
export const listMyOrders = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${configs.UrlPrefix}/api/orders/myorders/`, config);
...
export const listOrders = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${configs.UrlPrefix}/api/orders/`, config);
...
/* ACTION CREATOR USED IN MARKING CONFIRM STATUS OF ORDERS IN OrderScreen COMPONENT  */
export const confirmOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    /* MAKING API CALL TO UPDATE ORDER CONFIRM STATUS */
    const { data } = await axios.put(
      `${configs.UrlPrefix}/api/orders/${order._id}/confirm/`,
      {},
      config
    );
